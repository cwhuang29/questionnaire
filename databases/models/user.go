...
type User struct {
	...
	Role               int       `gorm:"not null" json:"role" yaml:"role"`
	BookmarkedArticles []Article `gorm:"many2many:users_articles_bookmark;"` // TODO
	LikedArticles      []Article `gorm:"many2many:users_articles_like;"`     // TODO
